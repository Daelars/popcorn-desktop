...
export const SETTINGS_METADATA: { readonly [K in SettingsKey]: SettingMetadata } = {
  ...
  ratingStars: meta({
    ...
    control: 'checkbox',
    section: 'interface',
    consumers: ['renderer:Poster'],
  }),
  showAdvancedSettings: meta({
    label: 'Show Advanced Settings',
    control: 'checkbox',
    section: 'interface',
    consumers: ['renderer:SettingsPage'],
  }),
  language: meta({
    label: 'Language',
    control: 'text',
  ...
  activateTorrentCollection: meta({
    ...
    control: 'checkbox',
    section: 'providers',
    consumers: ['renderer:TorrentCollectionPage'],
  }),
  toggleSengines: meta({
